...
- `data-style="default"` - Style variant (default, floating, clear, goober)
...
Text highlights with three variants. Use `class="shmoobium-highlight-marker:rgba(253,224,71,0.65)"` (or `-brush`, `-solid`) with your color in the class.

- `shmoobium-highlight-marker:rgba(r,g,b,a)` - Slanted, sharp edges
- `shmoobium-highlight-brush:rgba(r,g,b,a)` - Organic, irregular
- `shmoobium-highlight-solid:rgba(r,g,b,a)` - Simple solid background
